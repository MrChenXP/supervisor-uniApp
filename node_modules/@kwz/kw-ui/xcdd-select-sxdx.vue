<template>
  <!-- 随行督学选择页面 -->
    ...
    <view class="xcdd-select-gzjh-content">
      ...
      <view class="xcdd-select-sxdx-save clearfix">
        <button @tap="loadDataList()" class="fl" :disabled="!moreName">{{moreName ? "点击加载更多":"已无更多数据"}}</button>
        <button @tap="confirm" class="fr">确定</button>
      </view>
    ...
    methods:{
			...
			loadDataList (type) {
				...
				this.$kwz.ajax.ajaxUrl({
                 ...
                 this.moreName = false
                this.dataList = type ? [] : this.dataList
      ...
      // 选择时进行改变
      checkboxChange(e) {
        this.checkRadioA = e.detail.value;
				this.$emit("change",{
				  data: this.getCheckboxValue(this.checkRadioA)
				})
      },
      // 点击确定
      confirm(){
