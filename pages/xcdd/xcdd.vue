<template>
    ...
    <view class="gn">
      ...
      <view class="add fr" @click="goLink('xcdd-add')">新增</view>
    </view>
    <!-- 列表组 -->
    <view class="lists">
      <!-- 单项列表 -->
      <view class="list">
        ...
        <view class="info">
          ...
          <view class="clearfix status">
            ...
            <view v-if="true" class="fr bj"><uni-tag text="编辑"  size="small" circle="true" inverted="true" type="primary"></uni-tag></view>
          </view>
        </view>
      </view>
