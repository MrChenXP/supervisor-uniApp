<template>
    ...
    <kw-search placeholder="请输入学校名称">
      <view slot="content">
        ...
        <picker :range="xqList">
          <kw-list-cell title="学期"></kw-list-cell>
        </picker>
      </view>
    </kw-search>
    <!-- 功能(新增删除) -->
      ...
      <view class="list">
        ...
        <view class="info">
          ...
          <view class="clearfix status">
            <view v-if="true" class="fl clyj"><uni-tag text="这里放评估标准的名字" size="small" type="primary"></uni-tag></view>
            ...
            <view v-if="false" class="fr bj"><uni-tag text="去督导" size="small" circle="true" inverted="true" type="primary"></uni-tag></view>
            <view v-if="false" class="fr bj"><uni-tag text="处理"  size="small" circle="true" inverted="true" type="primary"></uni-tag></view>
