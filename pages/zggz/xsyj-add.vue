<template>
    ...
    <kw-list-cell  v-else title="编号" :rightNote="formData.BH"></kw-list-cell>
    <kw-list-cell v-if="!formData.ZGXSID" title="学校/单位" :rightNote="formData.XXMC" @click="schoolShow=true"></kw-list-cell>
    <kw-list-cell  v-else title="学校/单位" :rightNote="formData.XXMC"></kw-list-cell>
    <picker v-if="!formData.ZGXSID" :range="formData.XXMC[0]" @change="changeKs">
      <kw-list-cell title="科室/中心" :rightNote="formData.XS_ORG"></kw-list-cell>
    </picker>
    <kw-list-cell  v-else title="科室/中心" :rightNote="formData.XS_ORG[0]"></kw-list-cell>
      ...
      <view>
        ...
        <view class="ddjs-body">
          <view>
            ...
            <textarea maxlength="4000" :value="formData.XSNR"></textarea>
            <view>
