<template>
    ...
    <kw-search placeholder="请输入学校名称" @confirm="searchList">
      <view slot="content">
        ...
        <picker :range="searchCondition.DM_DD_ZGXSLY" range-key="DMMX_MC" :right-note="pageParam.zglxMc" @change="changeZglx">
      ...
      <view class="list" v-for="(item, index) in dataList" :key="index" >
        ...
        <view class="info">
          ...
          <view class="clearfix status">
            <view class="fl zgwc"><uni-tag text="整改完成" size="small" type="primary"></uni-tag></view>
            <view class="fl zgz"><uni-tag text="整改中" size="small" type="primary"></uni-tag></view>
            <view class="fl yys"><uni-tag text="已验收" size="small" type="primary"></uni-tag></view>
            <view class="fr ys"><uni-tag text="验收"  size="small" circle="true" inverted="true" type="primary"></uni-tag></view>
          </view>
        </view>
      </view>
